...
corpus = pd.read_csv(r"E:\FMI\Anul III\Licenta\chesti\dateDeAntrenament.csv",encoding ="latin-1")
...
#testarea 
testData = pd.read_csv(r"E:\FMI\Anul III\Licenta\chesti\nouTest1.csv",encoding ="latin-1")
