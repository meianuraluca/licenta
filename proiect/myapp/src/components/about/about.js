    ...
    <div className="about-container">
        <div className="about-content">
            <div className="about-content-text">
                <br/>
                 <p>Platforma online ”Oferă Speranță!„ are ca scop îmbunătățirea procesului de donație. Multe obiecte ajung să fie uitate în diferite zone de depozitare sau chiar mai rău să fie aruncate deși sunt într-o stare bună
